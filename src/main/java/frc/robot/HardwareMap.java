    ...
    public class IntakeHardware {
        ...
        public class SwerveHardware {
                ...
                public SwerveHardware() {
                        frontLeftDriveMotor = new CANSparkMax(DriveConstants.FRONT_LEFT_DRIVE_MOTOR_PORT,
                                        MotorType.kBrushless);
                        frontRightDriveMotor = new CANSparkMax(DriveConstants.FRONT_RIGHT_DRIVE_MOTOR_PORT,
                                        MotorType.kBrushless);
                        backLeftDriveMotor = new CANSparkMax(DriveConstants.REAR_LEFT_DRIVE_MOTOR_PORT,
                                        MotorType.kBrushless);
                        backRightDriveMotor = new CANSparkMax(DriveConstants.REAR_RIGHT_DRIVE_MOTOR_PORT,
                                        MotorType.kBrushless);

                        frontLeftTurningMotor = new CANSparkMax(DriveConstants.FRONT_LEFT_TURNING_MOTOR_PORT,
                                        MotorType.kBrushless);
                        ...
                        backLeftTurningMotor = new CANSparkMax(DriveConstants.REAR_LEFT_TURNING_MOTOR_PORT,
                                        MotorType.kBrushless);
                        backLeftTurningMotor.setIdleMode(IdleMode.kCoast);
                        backRightTurningMotor = new CANSparkMax(DriveConstants.REAR_RIGHT_TURNING_MOTOR_PORT,
                                        MotorType.kBrushless);
                        backRightTurningMotor.setIdleMode(IdleMode.kCoast);

                        frontLeftTurningEncoder = new AbsoluteEncoder(DriveConstants.FRONT_LEFT_TURNING_ENCODER_PORT,
                                        true, ModuleConstants.FRONT_LEFT_ROTATION_OFFSET);
                        frontRightTurningEncoder = new AbsoluteEncoder(DriveConstants.FRONT_RIGHT_TURNING_ENCODER_PORT,
                                        true, ModuleConstants.FRONT_RIGHT_ROTATION_OFFSET);
                        backLeftTurningEncoder = new AbsoluteEncoder(DriveConstants.REAR_LEFT_TURNING_ENCODER_PORT,
                                        true, ModuleConstants.REAR_LEFT_ROTATION_OFFSET);
                        backRightTurningEncoder = new AbsoluteEncoder(DriveConstants.REAR_RIGHT_TURNING_ENCODER_PORT,
                                        true, ModuleConstants.REAR_RIGHT_ROTATION_OFFSET);
                        ...
                        frontLeftSwerveModule = new SwerveModule("Front Left Swerve Module", frontLeftDriveMotor,
                                        frontLeftTurningMotor, ModuleConstants.TRACK_WIDTH / 2,
                                        ModuleConstants.WHEEL_BASE, frontLeftTurningEncoder);
                        frontRightSwerveModule = new SwerveModule("Front Right Swerve Module", frontRightDriveMotor,
                                        frontRightTurningMotor, ModuleConstants.TRACK_WIDTH,
                                        -ModuleConstants.WHEEL_BASE, frontRightTurningEncoder);
                        backLeftSwerveModule = new SwerveModule("Back Left Swerve Module", backLeftDriveMotor,
                                        backLeftTurningMotor, -ModuleConstants.TRACK_WIDTH, ModuleConstants.WHEEL_BASE,
                                        backLeftTurningEncoder);
                        backRightSwerveModule = new SwerveModule("Back Right Swerve Module", backRightDriveMotor,
                                        backRightTurningMotor, -ModuleConstants.TRACK_WIDTH,
                                        -ModuleConstants.WHEEL_BASE, backRightTurningEncoder);
